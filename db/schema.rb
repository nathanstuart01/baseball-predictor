...
ActiveRecord::Schema.define(version: 20170524210308) do
  ...
  create_table "batting_stats", force: :cascade do |t|
    ...
    t.integer  "team_id"
    t.index ["team_id"], name: "index_batting_stats_on_team_id", using: :btree
  end
  ...
  create_table "pitching_stats", force: :cascade do |t|
    ...
    t.datetime "updated_at",    null: false
    t.integer  "team_id"
    t.index ["team_id"], name: "index_pitching_stats_on_team_id", using: :btree
  end
